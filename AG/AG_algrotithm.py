...
class Individu:
    ...
    def __repr__(self) -> str:
        return f"Chromosome: {self.chromosome} Score: {str(self.score)}"
...
gene1 = Customer(1, 0, 0, 10)
gene2 = Customer(2, 0, 0, 100)
gene3 = Customer(3, 0, 0, 25)
gene4 = Customer(4, 0, 0, 15)
gene5 = Customer(5, 0, 0, 5)
